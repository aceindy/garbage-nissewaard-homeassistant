"""
Sensor component to monitor waste collection by Nissewaard.
Original Author:  Floris Kruisselbrink <floris+homeassistant@vloris.nl>
Modification by: Martin vdM <martin@vd-meer.com>

This repo works in Nissewaard
"""
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    _LOGGER.debug("Setting up Nissewaard API Reader...")
...
class AbstractWasteSensor(Entity):
    ...
    def __init__(self, reader, sensor_type):
        self._reader = reader
        self._schedule = None
        self._name = "Nissewaard {}".format(SENSOR_TYPES[sensor_type][0])
